...
class ChangeFavoriteCubit extends Cubit<ChangeFavoriteState> {
  ...
  Future<void> addIDItem2Favourite(int id , String url,
      {DestinationModel? destinationModel, AttractionModel? attractionModel, TripModel? tripModel, TripSearchModel? trip}) async {
    ...
    result.fold(
        ...
        if(trip!=null)trip.changeFavouriteStatus();
