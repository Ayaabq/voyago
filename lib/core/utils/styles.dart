...
class Styles {
  static const TextStyle textStyle32W700 = TextStyle(
      fontSize: 32, fontWeight: FontWeight.w900, overflow: TextOverflow.fade);
  static const TextStyle textStyle18W400 = TextStyle(
      fontSize: 19, fontWeight: FontWeight.w500, overflow: TextOverflow.fade);
  static const TextStyle textStyle18W700 = TextStyle(
      fontSize: 19, fontWeight: FontWeight.w900, overflow: TextOverflow.fade);

  static const TextStyle textStyle24W900 = TextStyle(
      fontSize: 24, fontWeight: FontWeight.w900, overflow: TextOverflow.fade);
  ...
  static TextStyle textStyle16W400blak = TextStyle(
      fontSize: 16,
      fontWeight: FontWeight.w400,
      overflow: TextOverflow.fade,
      color: CustomColors.kBlack[0]);
  static const TextStyle textStyle20W700 = TextStyle(
      fontSize: 20, fontWeight: FontWeight.w700, overflow: TextOverflow.fade);
  static TextStyle textStyle20W700blak = const TextStyle(
    fontSize: 20,
    overflow: TextOverflow.fade,
